...
Example Discord bot written in Python that uses the [completions API](https://beta.openai.com/docs/api-reference/completions) to have conversations with the `gpt-3.5-turbo` model, and the [chat API](https://platform.openai.com/docs/api-reference/chat/create) to filter the messages.
